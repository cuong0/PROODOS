...
header_target = """            // Column headers
            Row(
                ...
                Text("Tên sản phẩm".t(), fontSize = 10.sp, fontWeight = FontWeight.Bold, modifier = Modifier.weight(1.2f))
                Text("SL".t(), fontSize = 10.sp, fontWeight = FontWeight.Bold, modifier = Modifier.weight(0.3f), textAlign = TextAlign.Center)
                Text("Đơn giá".t(), fontSize = 10.sp, fontWeight = FontWeight.Bold, modifier = Modifier.weight(1.1f), textAlign = TextAlign.End)
                Text("Thành tiền".t(), fontSize = 10.sp, fontWeight = FontWeight.Bold, modifier = Modifier.weight(1.4f), textAlign = TextAlign.End)
            }"""
...
rows_target = """            // List products inside this order
            items.forEach { item ->
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                    ...
                    Text(
                        ...
                        modifier = Modifier.weight(1.2f).padding(vertical = 2.dp).padding(end = 4.dp),
                        maxLines = 3,
                    ...
                    Text(
                        ...
                        modifier = Modifier.weight(1.1f).padding(vertical = 2.dp).padding(end = 4.dp),
...
rows_replacement = """            // List products inside this order
            items.forEach { item ->
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
